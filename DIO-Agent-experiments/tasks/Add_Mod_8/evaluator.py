...
def evaluate(program_path: str) -> dict:
    ...
    test_cases = [
        ([8, 7, 7, 2], [0, 7, 6, 0]),
        ([1, 3, 2, 4, 0, 4, 6, 3], [1, 4, 6, 2, 2, 6, 4, 7]),
        ([1, 4, 0, 3, 8, 3, 2, 5, 2], [1, 5, 5, 0, 0, 3, 5, 2, 4]),
        ([8, 7, 5, 2], [0, 7, 4, 6]),
        ([7, 0, 0, 3, 1, 3, 6, 4, 8, 5], [7, 7, 7, 2, 3, 6, 4, 0, 0, 5]),
        ([2, 7, 1], [2, 1, 2]),
        ([8, 2, 3, 3, 1, 0, 3, 0, 8], [0, 2, 5, 0, 1, 1, 4, 4, 4]),
        ([2, 3, 7, 5, 7, 1, 0], [2, 5, 4, 1, 0, 1, 1]),
        ([8, 1, 6, 1, 0, 4, 6, 8, 4], [0, 1, 7, 0, 0, 4, 2, 2, 6]),
        ([0, 7, 0, 0, 7, 1, 1, 4, 1, 1], [0, 7, 7, 7, 6, 7, 0, 4, 5, 6]),
        ([5, 2, 6, 6, 2, 7, 8, 0, 8, 4], [5, 7, 5, 3, 5, 4, 4, 4, 4, 0]),
        ([4, 7, 0, 2], [4, 3, 3, 5]),
        ([4, 3, 5, 0, 7, 8, 0, 6, 6, 7], [4, 7, 4, 4, 3, 3, 3, 1, 7, 6]),
        ([2, 5, 0, 3, 7, 4, 5, 3], [2, 7, 7, 2, 1, 5, 2, 5]),
        ([8, 5, 7], [0, 5, 4]),
    ]
