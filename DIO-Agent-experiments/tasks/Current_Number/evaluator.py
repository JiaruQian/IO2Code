...
def evaluate(program_path: str) -> dict:
    ...
    test_cases = [
        ([72, 73, 68, 62], [72, 73, 68, 62]),
        ([16, 82, 40, 82, 82, 12, 82, 24, 19, 33], [16, 82, 40, 82, 82, 12, 82, 24, 19, 33]),
        ([89, 99, 32], [89, 99, 32]),
        ([100, 29, 80, 51, 9, 34, 3, 25, 82], [100, 29, 80, 51, 9, 34, 3, 25, 82]),
        ([23, 86, 42, 21, 11, 70], [23, 86, 42, 21, 11, 70]),
        ([89, 95, 47, 16, 84, 83, 63, 59, 1, 95], [89, 95, 47, 16, 84, 83, 63, 59, 1, 95]),
        ([31, 14, 92], [31, 14, 92]),
        ([51, 35, 64, 45, 5, 98], [51, 35, 64, 45, 5, 98]),
        ([58, 13, 54, 78, 70], [58, 13, 54, 78, 70]),
        ([26, 29, 13, 7, 26], [26, 29, 13, 7, 26]),
        ([66, 80, 36], [66, 80, 36]),
        ([31, 60, 75, 43, 59], [31, 60, 75, 43, 59]),
        ([4, 52, 67, 10], [4, 52, 67, 10]),
        ([72, 12, 89, 7, 35, 48, 67, 39, 98], [72, 12, 89, 7, 35, 48, 67, 39, 98]),
        ([6, 79, 99, 59, 5, 6, 58, 100, 12, 83], [6, 79, 99, 59, 5, 6, 58, 100, 12, 83]),
    ]
