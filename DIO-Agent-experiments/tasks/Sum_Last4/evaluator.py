...
def evaluate(program_path: str) -> dict:
    ...
    test_cases = [
        ...
        ([4, 20, 10, 20, 20, 3, 20, 6, 4, 8], [4, 24, 34, 54, 70, 53, 63, 49, 33, 38]),
        ([8, 12, 7], [8, 20, 27]),
        ([2, 8, 0, 6, 20, 16, 6, 5, 10], [2, 10, 10, 16, 34, 42, 48, 47, 37]),
        ([2, 17, 19, 14, 11], [2, 19, 38, 52, 61]),
        ([20, 15, 14, 0, 1], [20, 35, 49, 49, 30]),
        ([3, 20, 7, 12, 8, 16], [3, 23, 30, 42, 47, 43]),
        ([1, 5, 14, 3, 13, 19, 17, 5], [1, 6, 20, 23, 35, 49, 52, 54]),
        ([7, 3, 1, 6, 0, 16], [7, 10, 11, 17, 10, 23]),
        ([4, 7, 15, 18, 10, 14, 3], [4, 11, 26, 44, 50, 57, 45]),
        ([13, 16, 2], [13, 29, 31]),
        ([18, 3, 1, 8, 12, 16, 9, 15, 1], [18, 21, 22, 30, 24, 37, 45, 52, 41]),
        ([1, 1, 14, 3, 20, 3, 8, 2, 3, 17], [1, 2, 16, 19, 38, 40, 34, 33, 16, 30]),
        ([10, 4, 13, 12, 5, 14, 17, 1, 16, 9], [10, 14, 27, 39, 34, 44, 48, 37, 48, 43]),
        ([9, 14, 1, 4], [9, 23, 24, 28]),
    ]
