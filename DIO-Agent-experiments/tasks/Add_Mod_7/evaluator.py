...
def evaluate(program_path: str) -> dict:
    ...
    test_cases = [
        ([7, 7, 2, 5], [0, 0, 2, 0]),
        ([3, 2, 4, 0], [3, 5, 2, 2]),
        ([6, 3, 6, 1, 4, 0, 3], [6, 2, 1, 2, 6, 6, 2]),
        ([2, 5, 2, 1, 7, 5], [2, 0, 2, 3, 3, 1]),
        ([7, 7, 0, 0, 3], [0, 0, 0, 0, 3]),
        ([3, 6, 4, 5], [3, 2, 6, 4]),
        ([2, 7, 1], [2, 2, 3]),
        ([2, 3, 3, 1, 0, 3, 0, 4, 2], [2, 5, 1, 2, 2, 5, 5, 2, 4]),
        ([7, 5, 7, 1, 0, 6], [0, 5, 5, 6, 6, 5]),
        ([6, 1, 0, 4], [6, 0, 0, 4]),
        ([4, 7, 0, 7, 0, 0, 7, 1, 1], [4, 4, 4, 4, 4, 4, 4, 5, 6]),
        ([1, 1, 7, 5, 2, 6, 6], [1, 2, 2, 0, 2, 1, 0]),
        ([7, 0, 4, 1, 4], [0, 0, 4, 5, 2]),
        ([0, 2, 7, 4, 3, 5, 0, 7, 0, 6], [0, 2, 2, 6, 2, 0, 0, 0, 0, 6]),
        ([7, 5, 2, 5, 0, 3, 7, 4, 5], [0, 5, 0, 5, 5, 1, 1, 5, 3]),
    ]
