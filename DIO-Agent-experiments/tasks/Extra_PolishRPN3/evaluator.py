...
def evaluate(program_path: str) -> dict:
    ...
    test_cases = [
        ([3, 4, 10], [3, 4, 7]),
        ([3, 4, 12], [3, 4, 12]),
        ([2, 3, 12, 4, 10], [2, 3, 6, 4, 10]),
        ([9, 9, 7, 12, 12], [9, 9, 7, 63, 567]),
        ([3, 2, 12, 0], [3, 2, 6, 0]),
        ([6, 3, 6, 10, 8, 12, 10], [6, 3, 6, 9, 8, 72, 78]),
        ([5, 2, 7, 0, 10, 3, 4, 5, 10, 1, 12, 10, 10], [5, 2, 7, 0, 7, 3, 4, 5, 9, 1, 9, 12, 19]),
        ([0, 8, 2, 12, 11, 1], [0, 8, 2, 16, -16, 1]),
        ([6, 8, 11], [6, 8, -2]),
        ([0, 4, 4, 7, 12], [0, 4, 4, 7, 28]),
        ([0, 0, 1, 4, 1, 5, 11, 12, 11, 1], [0, 0, 1, 4, 1, 5, -4, -16, 17, 1]),
        ([0, 2, 9, 12, 5, 11, 0, 7, 9, 10], [0, 2, 9, 18, 5, 13, 0, 7, 9, 16]),
        ([4, 5, 12, 5, 7, 11, 11, 9, 5, 6, 11], [4, 5, 20, 5, 7, -2, 22, 9, 5, 6, -1]),
        ([2, 0, 0, 9, 6, 12, 6, 2], [2, 0, 0, 9, 6, 54, 6, 2]),
        ([3, 9, 11, 2, 11, 9, 3, 11, 12], [3, 9, -6, 2, -8, 9, 3, 6, -48]),
    ]
