...
def evaluate(program_path: str) -> dict:
    ...
    test_cases = [
        ...
        ([[0, 0], [1, 2], [2, 4], [3, 6]], False),
        ([[0, 0], [1, 1], [2, 3]], False),
        ([[-2, -1], [0, 0], [2, 1], [4, 2]], False),
        ([[-15, 16], [16, 14], [11, 10], [-12, 0], [-14, -8], [-11, -4], [16, -17]], False),
        ([[-4, 5], [-6, 20], [5, -16], [-3, -19], [-8, 12], [-7, -9], [1, -10]], False),
        ([[15, 18], [9, 3]], False),
        ([[11, 9], [-20, -17], [-5, -13]], False),
        ([[-6, 5], [-3, 12], [2, -18], [-10, 9], [-14, 7], [19, 15], [-10, -7]], False),
        ([[-14, -17], [-7, -19], [13, 20]], False),
        ([[-11, -5], [10, 17], [1, 9], [-14, -18]], False),
        ([[13, -15], [4, 16], [-14, -17], [-3, 4], [13, -1]], False),
        ([[-17, 19], [9, -18], [-17, 9], [-14, -14], [-4, -15]], False),
        ([[15, 11], [0, -11]], False),
        ([[5, -10], [8, 14], [-18, 12], [-1, 19], [13, -14]], False),
    ]
