...
def evaluate(program_path: str) -> dict:
    ...
    test_cases = [
        ([18, 18, 17, 15], [18, 36, 35, 32]),
        ([4, 20, 10, 20, 20, 3, 20, 6, 4, 8], [4, 24, 30, 30, 40, 23, 23, 26, 10, 12]),
        ([8, 12, 7], [8, 20, 19]),
        ([2, 8, 0, 6, 20, 16, 6, 5, 10], [2, 10, 8, 6, 26, 36, 22, 11, 15]),
        ([2, 17, 19, 14, 11], [2, 19, 36, 33, 25]),
        ([20, 15, 14, 0, 1], [20, 35, 29, 14, 1]),
        ([3, 20, 7, 12, 8, 16], [3, 23, 27, 19, 20, 24]),
        ([1, 5, 14, 3, 13, 19, 17, 5], [1, 6, 19, 17, 16, 32, 36, 22]),
        ([7, 3, 1, 6, 0, 16], [7, 10, 4, 7, 6, 16]),
        ([4, 7, 15, 18, 10, 14, 3], [4, 11, 22, 33, 28, 24, 17]),
        ([13, 16, 2], [13, 29, 18]),
        ([18, 3, 1, 8, 12, 16, 9, 15, 1], [18, 21, 4, 9, 20, 28, 25, 24, 16]),
        ([1, 1, 14, 3, 20, 3, 8, 2, 3, 17], [1, 2, 15, 17, 23, 23, 11, 10, 5, 20]),
        ([10, 4, 13, 12, 5, 14, 17, 1, 16, 9], [10, 14, 17, 25, 17, 19, 31, 18, 17, 25]),
        ([9, 14, 1, 4], [9, 23, 15, 5]),
    ]
