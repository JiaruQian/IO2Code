...
def evaluate(program_path: str) -> dict:
    ...
    test_cases = [
        ([8, 8, 7, 5], [8, 0, -1, -2]),
        ([-6, 10, 0, 10, 10, -7, 10, -4, -6, -2], [-6, 16, -10, 10, 0, -17, 17, -14, -2, 4]),
        ([-2, 2, -3], [-2, 4, -5]),
        ([-8, -2, -10, -4, 10, 6, -4, -5, 0], [-8, 6, -8, 6, 14, -4, -10, -1, 5]),
        ([-8, 7, 9, 4, 1], [-8, 15, 2, -5, -3]),
        ([10, 5, 4, -10, -9], [10, -5, -1, -14, 1]),
        ([-7, 10, -3, 2, -2, 6], [-7, 17, -13, 5, -4, 8]),
        ([-9, -5, 4, -7, 3, 9, 7, -5], [-9, 4, 9, -11, 10, 6, -2, -12]),
        ([-3, -7, -9, -4, -10, 6], [-3, -4, -2, 5, -6, 16]),
        ([-6, -3, 5, 8, 0, 4, -7], [-6, 3, 8, 3, -8, 4, -11]),
        ([3, 6, -8], [3, 3, -14]),
        ([8, -7, -9, -2, 2, 6, -1, 5, -9], [8, -15, -2, 7, 4, 4, -7, 6, -14]),
        ([-9, -9, 4, -7, 10, -7, -2, -8, -7, 7], [-9, 0, 13, -11, 17, -17, 5, -6, 1, 14]),
        ([0, -6, 3, 2, -5, 4, 7, -9, 6, -1], [0, -6, 9, -1, -7, 9, 3, -16, 15, -7]),
        ([-1, 4, -9, -6], [-1, 5, -13, 3]),
    ]
