...
def evaluate(program_path: str) -> dict:
    ...
    test_cases = [
        ([9, 9, 8, 7], [0, 0, 1, 1]),
        ([2, 10, 5, 10, 10, 1, 10, 3, 2, 4], [1, 2, 2, 3, 4, 4, 5, 5, 6, 7]),
        ([4, 6, 3], [1, 2, 2]),
        ([1, 4, 0, 3, 10, 8, 3, 2, 10], [0, 1, 2, 2, 3, 4, 4, 5, 6]),
        ([2, 1, 8, 9, 7, 5, 2, 10], [1, 1, 2, 2, 2, 2, 3, 4]),
        ([7, 0, 0, 3, 1, 10, 3, 6, 4, 8], [0, 1, 2, 2, 2, 3, 3, 4, 5, 6]),
        ([0, 2, 7, 1, 6, 9, 8, 2], [1, 2, 2, 2, 3, 3, 4, 5]),
        ([3, 1, 0, 3, 0, 8], [0, 0, 1, 1, 2, 3]),
        ([2, 3, 7, 9, 5, 7, 1], [1, 1, 1, 1, 1, 1, 1]),
        ([6, 8, 1], [1, 2, 2]),
        ([9, 1, 0, 4, 6, 8, 4, 7, 0], [0, 0, 1, 2, 3, 4, 5, 5, 6]),
        ([0, 0, 7, 1, 10, 1, 4, 1, 1, 8], [1, 2, 2, 2, 3, 3, 4, 4, 4, 5]),
        ([5, 2, 6, 6, 2, 7, 8, 0, 8, 4], [0, 1, 2, 3, 4, 4, 5, 6, 7, 8]),
        ([4, 7, 0, 2], [1, 1, 2, 3]),
        ([9, 4, 9, 3, 5, 0, 9, 7, 8, 0], [0, 1, 1, 1, 1, 2, 2, 2, 3, 4]),
    ]
