...
def evaluate(program_path: str) -> dict:
    ...
    test_cases = [
        ...
        ([[0, 0], [1, 1], [2, 3]], 6),
        ([[-2, -1], [0, 0], [2, 1], [4, 2]], 18),
        ([[-15, 16], [16, 14], [11, 10], [-12, 0], [-14, -8], [-11, -4], [16, -17]], 1023),
        ([[-4, 5], [-6, 20], [5, -16], [-3, -19], [-8, 12], [-7, -9], [1, -10]], 507),
        ([[15, 18], [9, 3]], 90),
        ([[11, 9], [-20, -17], [-5, -13]], 806),
        ([[-6, 5], [-3, 12], [2, -18], [-10, 9], [-14, 7], [19, 15], [-10, -7]], 1089),
        ([[-14, -17], [-7, -19], [13, 20]], 1053),
        ([[-11, -5], [10, 17], [1, 9], [-14, -18]], 840),
        ([[13, -15], [4, 16], [-14, -17], [-3, 4], [13, -1]], 891),
        ([[-17, 19], [9, -18], [-17, 9], [-14, -14], [-4, -15]], 962),
        ([[15, 11], [0, -11]], 330),
        ([[5, -10], [8, 14], [-18, 12], [-1, 19], [13, -14]], 1023),
    ]
