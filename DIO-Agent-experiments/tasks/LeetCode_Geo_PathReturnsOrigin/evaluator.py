...
def evaluate(program_path: str) -> dict:
    ...
    test_cases = [
        ...
        ([[-15, 16], [16, 14], [11, 10], [-12, 0], [-14, -8], [-11, -4], [16, -17]], False),
        ([[-4, 5], [-6, 20], [5, -16], [-3, -19], [-8, 12], [-7, -9]], False),
        ([[1, -10], [-15, 15], [18, 9], [3, -12], [11, 9], [-20, -17], [-5, -13]], False),
        ([[-6, 5], [-3, 12], [2, -18], [-10, 9], [-14, 7], [19, 15]], False),
        ([[-10, -7], [-6, -14], [-17, -7], [-19, 13], [20, -2], [-11, -5], [10, 17]], False),
        ([[9, -14], [-18, 6], [13, -15]], False),
        ([[4, 16], [-14, -17], [-3, 4], [13, -1], [11, -17], [19, 9], [-18, -17]], False),
        ([[-14, -14], [-4, -15], [-14, 15], [11, 0]], False),
        ([[7, 5], [-10, 8]], False),
        ([[-18, 12], [-1, 19], [13, -14], [-1, 8], [-17, -12]], False),
        ([[11, 17], [-3, 18], [-6, 2], [-18, 16], [11, 13], [-20, 4], [6, 8]], False),
    ]
