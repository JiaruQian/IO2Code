...
def evaluate(program_path: str) -> dict:
    ...
    test_cases = [
        ([[6, 4, 4, 4], [3, 3, 1, 6]], [3, 0]),
        ([[5, 6, 5, 6, 6, 0, 5, 6], [1, 1, 2, 4, 0, 5, 6, 2]], [4, 3]),
        ([[6, 1, 6, 5, 3, 0, 2, 0, 1], [5, 6, 4, 1, 1, 6, 5, 2, 1]], [0, 5]),
        ([[4, 4, 3, 5], [5, 2, 1, 5]], [1, 1]),
        ([[3, 0, 5, 0, 1, 0, 5, 6, 5, 1], [3, 6, 2, 6, 4, 2, 0, 6, 1, 3]], [3, 2]),
        ([[3, 4, 4, 6], [1, 1, 1, 0]], [0, 3]),
        ([[1, 0, 4], [5, 2, 1]], [1, 0]),
        ([[3, 4, 2, 6, 3, 0], [6, 0, 3, 4, 0, 6]], [0, 0]),
        ([[4, 0, 6, 5, 0, 2, 3, 4, 2], [6, 6, 3, 0, 4, 6, 3, 0, 0]], [4, 5]),
        ([[6, 6, 0, 5, 0, 2, 6, 0, 6, 6], [0, 4, 3, 2, 1, 3, 6, 6, 3, 1]], [5, 5]),
        ([[4, 0, 4, 2, 4, 4, 0, 6, 2, 3], [0, 1, 6, 3, 4, 2, 6, 4, 6, 1]], [4, 1]),
        ([[0, 4, 3, 4, 6, 0, 3, 3], [3, 4, 2, 5, 4, 1, 2, 0]], [4, 0]),
        ([[3, 2, 2, 1, 0, 4], [5, 2, 5, 6, 6, 3]], [5, 0]),
        ([[5, 2, 2], [2, 3, 4]], [0, 6]),
        ([[2, 3, 0, 6], [3, 3, 2, 3]], [5, 6]),
    ]
