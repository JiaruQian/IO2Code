...
def evaluate(program_path: str) -> dict:
    ...
    test_cases = [
        ([72, 73, 68, 62], [0, 0, 0, 0]),
        ([16, 82, 40, 82, 82, 12, 82, 24, 19, 33], [0, 0, 0, 0, 0, 16, 82, 40, 82, 82]),
        ([89, 99, 32], [0, 0, 0]),
        ([100, 29, 80, 51, 9, 34, 3, 25, 82], [0, 0, 0, 0, 0, 100, 29, 80, 51]),
        ([23, 86, 42, 21, 11, 70], [0, 0, 0, 0, 0, 23]),
        ([89, 95, 47, 16, 84, 83, 63, 59, 1, 95], [0, 0, 0, 0, 0, 89, 95, 47, 16, 84]),
        ([31, 14, 92], [0, 0, 0]),
        ([51, 35, 64, 45, 5, 98], [0, 0, 0, 0, 0, 51]),
        ([58, 13, 54, 78, 70], [0, 0, 0, 0, 0]),
        ([26, 29, 13, 7, 26], [0, 0, 0, 0, 0]),
        ([66, 80, 36], [0, 0, 0]),
        ([31, 60, 75, 43, 59], [0, 0, 0, 0, 0]),
        ([4, 52, 67, 10], [0, 0, 0, 0]),
        ([72, 12, 89, 7, 35, 48, 67, 39, 98], [0, 0, 0, 0, 0, 72, 12, 89, 7]),
        ([6, 79, 99, 59, 5, 6, 58, 100, 12, 83], [0, 0, 0, 0, 0, 6, 79, 99, 59, 5]),
    ]
