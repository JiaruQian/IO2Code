...
from dio_agent.config import DatabaseConfig
from dio_agent.utils.code_utils import calculate_edit_distance
from dio_agent.utils.metrics_utils import safe_numeric_average, get_fitness_score

logger = logging.getLogger(__name__)


def _build_embedding_client(model_name: Optional[str]):
    if not model_name:
        return None

    from dio_agent.embedding import EmbeddingClient
...
class ProgramDatabase:
    ...
    def __init__(self, config: DatabaseConfig):
        ...
        self.embedding_client = _build_embedding_client(config.embedding_model)
    ...
    def _llm_judge_novelty(self, program: Program, similar_program: Program) -> bool:
        ...
        """
        import asyncio
        from dio_agent.novelty_judge import NOVELTY_SYSTEM_MSG, NOVELTY_USER_MSG
    ...
    def migrate_programs(self) -> None:
        ...
        for i, island in enumerate(self.islands):
            ...
            for migrant in migrants:
                ...
                #
                # This is particularly problematic for DIO-Agent's MAP-Elites + island architecture:
