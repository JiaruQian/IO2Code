"""
Configuration handling for DIOAgent
"""
...
class PromptConfig:
    ...
    # Number of previous attempts shown in prompt history (0 disables this section content)
    max_previous_attempts: int = 3
    # Optional override for inspiration count; defaults to num_top_programs for compatibility
...
class DatabaseConfig:
    ...
    feature_dimensions: List[str] = field(
        ...
        metadata={
            ...
            "NOT pre-computed bin indices. DIOAgent handles all scaling and binning internally."
        },
    )
...
@dataclass
class Config:
    """Master configuration for DIOAgent"""
